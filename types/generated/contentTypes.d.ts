...
export interface ApiAboutBumilangitAboutBumilangit
  extends Struct.SingleTypeSchema {
  collectionName: 'about_bumilangits';
  info: {
    singularName: 'about-bumilangit';
    pluralName: 'about-bumilangits';
    displayName: 'AboutBumilangit';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::about-bumilangit.about-bumilangit'
    >;
  };
}

export interface ApiAboutUniverseAboutUniverse extends Struct.SingleTypeSchema {
  collectionName: 'about_universes';
  info: {
    singularName: 'about-universe';
    pluralName: 'about-universes';
    displayName: 'AboutUniverse';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::about-universe.about-universe'
    >;
  };
}
...
export interface ApiArtistArtist extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    director: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'director'>;
    productionHouse: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiBrandBrand extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    projects: Schema.Attribute.Relation<
      'oneToMany',
      'api::brand-project.brand-project'
    >;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiBrandProjectBrandProject
  extends Struct.CollectionTypeSchema {
...
export interface ApiCharacterCharacter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    mainPoseImage: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    alternativePoseImage: Schema.Attribute.Media<'images'> &
      Schema.Attribute.Required;
    ...
    isSpotlight: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    isTopComic: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    abilities: Schema.Attribute.Relation<
      'oneToMany',
    ...
    characterGroups: Schema.Attribute.Relation<
      'manyToMany',
      'api::character-group.character-group'
    >;
    movies: Schema.Attribute.Relation<'manyToMany', 'api::movie.movie'>;
    comics: Schema.Attribute.Relation<'manyToMany', 'api::comic.comic'>;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiCharacterAbilityCharacterAbility
  extends Struct.CollectionTypeSchema {
...
export interface ApiCharacterGroupCharacterGroup
  extends Struct.CollectionTypeSchema {
...
export interface ApiComicComic extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    story: Schema.Attribute.String & Schema.Attribute.Required;
    illustrator: Schema.Attribute.String & Schema.Attribute.Required;
    coloring: Schema.Attribute.String & Schema.Attribute.Required;
    ISBN: Schema.Attribute.String & Schema.Attribute.Required;
    publishDate: Schema.Attribute.Date & Schema.Attribute.Required;
    buyLink: Schema.Attribute.String & Schema.Attribute.Required;
    isTokopediaAvailable: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    ...
    isFeatured: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    isLimited: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    ...
    characters: Schema.Attribute.Relation<
      ...
      'api::character.character'
    >;
    relatedMovies: Schema.Attribute.Relation<'manyToMany', 'api::movie.movie'>;
    relatedComics: Schema.Attribute.Relation<'oneToMany', 'api::comic.comic'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiComicLineComicLine extends Struct.CollectionTypeSchema {
  collectionName: 'comic_lines';
  info: {
    singularName: 'comic-line';
    pluralName: 'comic-lines';
    displayName: 'ComicLine';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiDigitalLineDigitalLine extends Struct.CollectionTypeSchema {
  collectionName: 'digital_lines';
  info: {
    singularName: 'digital-line';
    pluralName: 'digital-lines';
    displayName: 'DigitalLine';
    description: '';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    ...
    digitalProducts: Schema.Attribute.Relation<
      'oneToMany',
      'api::digital-product.digital-product'
    >;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::digital-line.digital-line'
    >;
  };
}

export interface ApiDigitalProductDigitalProduct
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    releaseStatus: Schema.Attribute.Enumeration<['UPCOMING', 'RELEASED']> &
      Schema.Attribute.Required;
    link: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    isPlayStoreAvailable: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    isAppStoreAvailable: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    digitalLine: Schema.Attribute.Relation<
      'manyToOne',
      'api::digital-line.digital-line'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiFooterBrandingFooterBranding
  ...
  info: {
    singularName: 'footer-branding';
    pluralName: 'footer-brandings';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::footer-branding.footer-branding'
    >;
  };
}
...
export interface ApiMovieMovie extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    movieLine: Schema.Attribute.Relation<
      'manyToOne',
    ...
    isXXIAvailable: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
      ...
      Schema.Attribute.DefaultTo<false>;
    isCGVAvailable: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
      ...
      Schema.Attribute.DefaultTo<false>;
    isANTVAvailable: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
      ...
      Schema.Attribute.DefaultTo<false>;
    isYTAvailable: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiMovieLineMovieLine extends Struct.CollectionTypeSchema {
  collectionName: 'movie_lines';
  info: {
    singularName: 'movie-line';
    pluralName: 'movie-lines';
...
export interface ApiNewsItemNewsItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['COMIC', 'MOVIES & SERIES', 'MEDIA RELEASE']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    isHeadline: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiPartnershipLicensingPartnershipLicensing
  extends Struct.SingleTypeSchema {
  collectionName: 'partnership_licensings';
  info: {
    singularName: 'partnership-licensing';
    pluralName: 'partnership-licensings';
    displayName: 'PartnershipLicensing';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::partnership-licensing.partnership-licensing'
    >;
  };
}
...
export interface ApiPodcastWidgetPodcastWidget extends Struct.SingleTypeSchema {
  collectionName: 'podcast_widgets';
  info: {
    singularName: 'podcast-widget';
    pluralName: 'podcast-widgets';
    displayName: 'PodcastWidget';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::podcast-widget.podcast-widget'
    >;
  };
}

export interface ApiRakyatBumilangitRakyatBumilangit
  extends Struct.SingleTypeSchema {
  collectionName: 'rakyat_bumilangits';
  info: {
    singularName: 'rakyat-bumilangit';
    pluralName: 'rakyat-bumilangits';
    displayName: 'RakyatBumilangit';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::rakyat-bumilangit.rakyat-bumilangit'
    >;
  };
}
...
export interface ApiShopBannerShopBanner extends Struct.CollectionTypeSchema {
  collectionName: 'shop_banners';
  info: {
    singularName: 'shop-banner';
    pluralName: 'shop-banners';
    displayName: 'ShopBanner';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiShopCategoryShopCategory
  extends Struct.CollectionTypeSchema {
...
export interface ApiShopProductShopProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    category: Schema.Attribute.Enumeration<
      ['COMIC', 'APPARELS', 'ACCESSORIES', 'TOYS', 'COLLECTIBLES']
    > &
      Schema.Attribute.Required;
    image: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    price: Schema.Attribute.BigInteger & Schema.Attribute.Required;
...
export interface ApiUniverseLineUniverseLine
  extends Struct.CollectionTypeSchema {
  collectionName: 'universe_lines';
  info: {
    singularName: 'universe-line';
    pluralName: 'universe-lines';
    displayName: 'UniverseLine';
  };
  options: {
    draftAndPublish: false;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::universe-line.universe-line'
    >;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::about-bumilangit.about-bumilangit': ApiAboutBumilangitAboutBumilangit;
      'api::about-universe.about-universe': ApiAboutUniverseAboutUniverse;
      'api::artist.artist': ApiArtistArtist;
      'api::banner.banner': ApiBannerBanner;
      'api::brand.brand': ApiBrandBrand;
      'api::brand-project.brand-project': ApiBrandProjectBrandProject;
      'api::character.character': ApiCharacterCharacter;
      'api::character-ability.character-ability': ApiCharacterAbilityCharacterAbility;
      'api::character-group.character-group': ApiCharacterGroupCharacterGroup;
      'api::comic.comic': ApiComicComic;
      'api::comic-line.comic-line': ApiComicLineComicLine;
      ...
      'api::partnership-licensing.partnership-licensing': ApiPartnershipLicensingPartnershipLicensing;
      'api::podcast.podcast': ApiPodcastPodcast;
      'api::podcast-widget.podcast-widget': ApiPodcastWidgetPodcastWidget;
      'api::rakyat-bumilangit.rakyat-bumilangit': ApiRakyatBumilangitRakyatBumilangit;
      ...
      'api::universe-line.universe-line': ApiUniverseLineUniverseLine;
